...
public class Sint175P4 extends HttpServlet{

    FrontEnd frontEnd = new FrontEnd();

    //METHOD THAT CALLS THE errorChecker() TO GO THROUGH ALL MUMLs AND CHECK THEM
    public void init(){ 
        try{
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException{ 
        ...
        String correct_password = "Practice04"; //MY PASSWORD
        ...
        //ARRAYLIST WHERE WE WILL SAVE THE INFO FROM THE GETTERS OF DATAMODEL 
        ...
        try{
            ...
            //EMPTY PASSWORD
            if (passwd==null){
                if (req.getParameter("auto")!=null && req.getParameter("auto").equals("true")==true){ //AUTO MODE SCREEN
