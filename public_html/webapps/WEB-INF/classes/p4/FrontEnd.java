...
//PHASE 13 ?p="+password+"&pphase=13&pcountry="+country+"&paid="aid"
    public void doGetPhase13_auto(PrintWriter out,ArrayList<song> list_songs) {
        ...
        for (int i = 0; i < list_songs.size(); i++) {
            out.println("<song lang='"+list_songs.get(i).getLanguage()+"' genres='"+list_songs.get(i).getGenre()+"' composer='"+list_songs.get(i).getComposer()+"'>"+list_songs.get(i).getTitle()+"</song>");
        }
        out.println("</songs>");
    }
    ...
    public void doGetPhase13_browser(PrintWriter out, String password, ArrayList<song> list_songs, String country, String aid){
        ...
        out.println("<ol>");
        for (int i = 0; i < list_songs.size(); i++) {
            out.println("<li><b>Title: </b>'"+list_songs.get(i).getTitle()+"'<b> --- Language: </b>'"+list_songs.get(i).getLanguage()+"'<b> --- Genres: </b>'"+list_songs.get(i).getGenre()+"'<b> --- Composer: </b>'"+list_songs.get(i).getComposer()+"'</li>");
        }
        out.println("</ol>");
        out.println("<br><button id='home_button' onclick=\"location.href='?p="+password+"&pphase=01'\">Home</button>");
